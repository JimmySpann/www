 ...
 * @desc Enable the CT Hud at the start of the game.
 * @default true
 *
 * @param Dash Cost
 * @desc Enable Dash cost.
 * @default true
 *
 * @param Full SE
 * @desc SE definition when the bar reaches maximum.
 * @default 
 *
 * @param Smart Fade
 * @desc Make the Hud semi-transparent when the character approaches the hud.
 * @default true
 *
 * @param Slant Animation
 * @desc Enable gradient animation on the CT gauge.
 * @default true
 *
 * @param Hud X-Axis
 * @desc X-axis position of the CT hud.
 * @default 70
 *
 * @param Hud Y-Axis
 * @desc Y-axis position of the CT hud.
 * @default 460
 *
 * @param Number X-Axis
 * @desc X-axis position of the CT value.
 * @default 155
 *
 * @param Number Y-Axis
 * @desc Y-axis position of the CT value.
 * @default 3
 *
 * @help  
 * =============================================================================
 ...
 * =============================================================================
 * Adds the CT parameter, similar to MP. The CT parameter is recovered every
 * second, and is used for character actions such as attacking, using items,
 * running, etc...
 *
 * =============================================================================
 * PLUGIN COMMANDS
 ...
 * 
 * ct_hud_visible : true
 * - Enables or disables the CT hud.
 *
 * dash_ct_cost : true
 * - Enables or disables the CT cost for Dash.
 *
 * action_ct_cost : true
 * - Enables or disables the CT cost for actions. 
 *
 * =============================================================================
 ...
 * 
 * tool_ct_cost : VALUE
 * - Sets a CT cost for the action.
 *
 * =============================================================================
 * CHANGELOG
 * =============================================================================
 * (v1.1) - Fixed plugin parameters not working.
 *
 */
