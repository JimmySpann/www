...
"use strict"; if (!Imported || !Imported.OcRam_Core) alert('OcRam_Core.js ' +
    'is required!'); OcRam.addPlugin("Weather_EX", "2.10");

/*:
 * @plugindesc v2.10 Weather Extensions to default weather system.
...
(function () {
            ...
            if (_noLightnings) {
                ...
                if (AudioManager._currentBgs2 !== null) {
                    ...
                    AudioManager.playBgs2({
                        ...
                        pitch: AudioManager._currentBgs2.pitch * _indoorsPitchMultiplier,
                ...
                if (AudioManager._currentBgs3 !== null) {
                    ...
                    AudioManager.playBgs3({
                        ...
                        pitch: AudioManager._currentBgs3.pitch * _indoorsPitchMultiplier,
    ...
    function getCurrentWeatherBGS2() {
        ...
        switch (cwid) {
            ...
            default:
                if (_currentRndWeather) this_bgs = { name: _currentRndWeather.WeatherBGS2, volume: (_currentRndWeather.Power * 10 + 10), pitch: 100, pan: 0, pos: 0 }; break;
        } if ($gameSystem.isIndoors()) { this_bgs.volume *= _indoorsVolumeMultiplier; this_bgs.pitch *= _indoorsPitchMultiplier; }
        return this_bgs;
    }
