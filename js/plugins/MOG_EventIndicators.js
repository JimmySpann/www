...
/*:
 * @plugindesc (v1.0) Displays animated indicators above events.
 * @author Moghunter
 * 
 * @param Default Font Size
 * @desc Font size setting.
 * @default 16
 * 
 ...
 * =============================================================================
 * Displays animated indicators above events.
 *
 * =============================================================================
 * IMAGES
 * =============================================================================
 * Save the indicator images in the /img/eventindicators/ folder.
 *
 * -----------------------------------------------------------------------------
 * ANIMATED (Frames)
 * -----------------------------------------------------------------------------
 ...
 * COMMENT (EVENT)
 * =============================================================================
 * To activate the indicator, place the comments below in the event.
 *
 * ------------------------------------------------------------------------------
 *
 * indicator : FILENAME : X : Y
 *
 * FILENAME - File name definition.
 * X - X-Axis position of the image.
 * Y - Y-Axis position of the image.
 *
 * =============================================================================
 * EXTRA COMMENT (OPTIONAL)
 * =============================================================================
 *
 * TEXT - To add text to the indicator, use the comment below.
 *
 * text_indicator : TEXT
 *
 * ------------------------------------------------------------------------------
 ...
 *  
 * ------------------------------------------------------------------------------
 * RANGE VISIBILITY - To enable visibility by distance, place this
 * comment.
 *
 * range_indicator : RANGE
 *
 * ------------------------------------------------------------------------------
 * ANIMATED - To enable frame animation, use this comment.
 *
 * animated_indicator : FRAMES : ANIMATION_SPEED
 *
 * ------------------------------------------------------------------------------
 * FONT_SIZE - To adjust the font size, use the comment below.
 *
 * fontsize_indicator : X : Y
 *  
 * ------------------------------------------------------------------------------
 * BLEND MODE - To adjust the blend type, use the comment below.
 *
 * blendmode_indicator : BLEND_MODE
 *
 * ------------------------------------------------------------------------------
 * ROTATION - To enable rotation animation, use the comment below.
 *
 * rotation_indicator : ROTATION_SPEED
 * 
 * ------------------------------------------------------------------------------
 * SHAKE - To enable shake animation, use the comment below.
 *
 * shake_indicator : SHAKE_POWER
 * ------------------------------------------------------------------------------
 * PULSE - To enable pulse animation, use the comment below.
 *
 * pulse_indicator : PULSE_POWER
 *
 * ------------------------------------------------------------------------------
 * FLOAT - To enable levitation animation, use the comment below.
 *
 * float_indicator
 *
 * ------------------------------------------------------------------------------
 * SLIDE - To enable slide animation, use the comment below.
 *
 * slide_indicator
 *
 * ------------------------------------------------------------------------------
 * CLEAR - To erase the indicator, use the comment below.
 *
 * clear_indicator
 *    
 * =============================================================================
 * PLUGIN COMMAND
 * =============================================================================
 * To show or hide indicators, use the commands below.
 *
 * show_indicator : EVENT_ID
 * hide_indicator : EVENT_ID
 *
 * To show or hide all indicators, use the command below.
 *
 * show_all_indicators
 * hide_all_indicators
 *
