...
/*:
 * @plugindesc (v1.4) System for throwing events.
 * @author Moghunter
 *
 * @param Character Height
 * @desc Character height setting.
 * @default 22
 *
 * @param Character Pose
 * @desc Enable carry object pose.
 * @default true
 *
 * @param Hold Direction
 * @desc Enable hold direction button.
 * @default true
 *
 * @param Hold Direction Button
 * @desc Button definition to hold direction.
 * @default pagedown
 * 
 * @param Sound File
 ...
 * =============================================================================
 * The system allows you to throw objects (Events) on the map.
 *
 * =============================================================================
 * EVENT COMMENTS
 * =============================================================================
 * To define the object to be thrown, place this comment in the event.
 *
 * throw : X
 *
 ...
 * CHARACTER POSES
 * =============================================================================
 * To define the character pose image name, name the image as follows.
 *
 ...
 * PLUGIN COMMAND
 * =============================================================================
 * To enable or disable the system, use the plugin commands below.
 *
 * pickup_enable
 * 
 * pickup_disable
 ...
 * CHANGELOG
 * =============================================================================
 * v1.4 - Improved coding.  
 * v1.3 - Compatibility with Char Poses plugin. 
 * v1.2 - Changed noteTag to standardize command format.
 * v1.1 - Added plugin command to enable and disable the system.
 */
